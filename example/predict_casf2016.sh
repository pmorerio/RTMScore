...
###
rm -r $data_dir $results_concatenated_dir #$results_coreset_dir $results_decoys_dir
###
mkdir $data_dir $results_concatenated_dir #$results_coreset_dir $results_decoys_dir
sample_count=0
